  ...
  return (
    <>
      ...
      >
        ...
        />
        {/* Text content */}
        <div className="container-x relative py-16 lg:flex lg:min-h-[86vh] lg:items-center lg:py-20">
        ...
        {/* Hero image — mobile only, shown below the text block */}
        <div className="relative h-[340px] overflow-hidden lg:hidden">
          <Image
            src={IMAGES.heroTeam}
            alt=""
            aria-hidden
          ...
          />
          {/* fade top edge into the navy text section above */}
          <div
            aria-hidden
            className="absolute inset-x-0 top-0 h-16 bg-gradient-to-b from-[#00152e] to-transparent"
          />
        </div>
      </section>
