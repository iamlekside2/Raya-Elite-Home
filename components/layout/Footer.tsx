      ...
      <div className="container-x relative grid grid-cols-[repeat(auto-fit,minmax(210px,1fr))] gap-12 pt-20">
        ...
        <div>
          ...
          <div className="flex gap-3">
            {/* Instagram */}
            <a href={SITE.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full border border-paper/20 text-paper/70 transition-all hover:border-[#C9A84C] hover:bg-[#C9A84C] hover:text-[#002147]">
            ...
            {/* Facebook / LinkedIn / TikTok — re-enable as the accounts go live:
        ...
        <div>
          ...
          <div className="text-[15px] leading-[1.9] text-paper/70">
            ...
            <div className="mt-[10px]">{SITE.address}</div>
            <div>Serving {SITE.area}</div>
          </div>
        </div>
      </div>
